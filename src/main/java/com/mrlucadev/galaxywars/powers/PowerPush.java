...
public class PowerPush extends PowerAbility {
	...
	public Component getDisplayName() {
		return Lang.getMessage("powers.abilities.push");
	}

	@Override
	public int getCooldown() {
		return GalaxyWars.getCfg().getInt("powers.push.cooldown");
	}

	@Override
	public int getCost() {
		return GalaxyWars.getCfg().getInt("powers.push.energycost");
	}
